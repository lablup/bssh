...
pub(crate) struct ProtocolState {
    ...
    /// Screen selected when bssh took control, as reported by DEC mode 1049.
    ///
    /// This is a buffer selector, not a promise that the 1049 mode bit and its
    /// single cursor-save slot can both be restored without clearing content.
    pub(crate) initial_screen_alternate: Option<bool>,
    /// Last observed DECSET/DECRST 1049 state from the remote session.
